...
function md_to_m2(permeability_md::Float64)
    return permeability_md * 9.869233e-16  # conversion factor from mD to m²
end
...
struct HydrologyParams
    ...
    aquifer_thickness::Float64    # [m]
    density::Float64             # [kg/m³]
    dynamic_viscosity::Float64   # [Pa·s]
    fluid_compressibility::Float64  # [1/Pa]
    rock_compressibility::Float64   # [1/Pa]
end
