...
[fileNameToPrint,path2] = uiputfile({'*.jpg';'*.png';'*.tif';'*.eps'},['Save ',axisTitles{axisCount},' Image']);
...
switch path_file(end-3:end) % last 4 characters
    ...
    otherwise
        errorWindow44=errordlg(['couldn''t export because the file extension must be either: .jpg, .tif, or .png, but you entered: ',path_file(end-3:end)]);
